...
public class Task6_PersonCharacteristics {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            System.out.printf("%s %s is %d years old. He was born in %d. " + "His weight is %f and he is %d cm tall. He is a %s.", firstName, lastName, age, yearBorn, weight, height, occupation);
            
            if (age < 18) {
                System.out.print(" " + firstName + " " + lastName + " under-aged.");
            }
            System.out.println();
        }
    }
